...
-- -----------------------------------------------------------------------------
-- Quarterly estimated tax payments (mark paid on Tax page)
-- -----------------------------------------------------------------------------
...
DROP POLICY IF EXISTS "Users manage own quarterly_tax_payments" ON public.quarterly_tax_payments;
