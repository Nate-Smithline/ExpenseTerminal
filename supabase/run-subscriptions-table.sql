-- Run this once in Supabase Dashboard → SQL Editor to create the subscriptions table.
...
-- Optional: add AI eligibility column to transactions if you don't have it yet
