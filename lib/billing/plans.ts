...
export const plans: Record<PlanId, PlanDefinition> = {
  free: {
    ...
    description: "Start in tax triage and prove the value before you subscribe.",
    highlights: [
      "Tax triage until ExpenseTerminal finds $36 in deductions",
      "CSV uploads for bank and card exports",
      "AI-suggested business, personal, and partial splits",
      "Schedule C-focused categorization and notes",
      "Upgrade for Budget, Cash Flow, and unlimited triage",
    ],
